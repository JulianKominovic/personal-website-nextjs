...
const Hobby = ({}: Props) => {
  return (
    <Section className="min-h-screen overflow-visible">
      ...
      <Link
        href={"/hobby"}
        className="inline-flex items-center gap-2 mx-auto mt-4 btn w-max group"
      >
      ...
      <div className="flex flex-wrap justify-center max-w-6xl gap-4 mx-auto mt-28">
        {readAbstractWallpapersFileName().map((fileName) => {
          ...
          return (
            <BigCardContainer
              ...
              key={fileName}
              target="_blank"
              className="h-auto mx-0 w-[512px] aspect-auto overflow-hidden hover:scale-95 transition-transform"
            >
              <Image
                loading="lazy"
                width={900}
